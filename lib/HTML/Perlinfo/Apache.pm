...
sub perl_info_print_apache {
	...
	return join '', perl_info_print_table_row(2, "Apache Version", "$version"),
			...
			perl_info_print_table_row(2, "Loaded Modules", "<i>Not detected</i>");
}
...
sub perl_info_print_apache_environment {
	...
	return join '', perl_info_print_table_row(2, "DOCUMENT_ROOT", "$ENV{'DOCUMENT_ROOT'} "),
